...
import { toggleTour } from "../../redux/slices/tourBookingSlice";
import { Status } from "../../enums/status.enum";

const EditTourBookingModal = ({ show, handleClose, edit,action }) => {
    ...
    const handleUpdateSubmit = async (event) => {
        ...
        try {
            ...
            await dispatch(toggleTour({ id: edit._id, action:action })).unwrap();
            handleClose();
